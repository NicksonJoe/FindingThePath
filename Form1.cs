...
namespace BRIO_MRS_testTask
{
	public partial class RadioTransmitterDetectionSystem : Form
	{
		...
		#endregion default values for coordinate system
		...
		public int CoordX(double coord)
		{
			return (int)(Math.Round(coord, 1) * 10) + 558 / 2;
		}

		public int CoordY(double coord)
		{
			return (int)(Math.Round(coord, 1) * -10) + 491 / 2;
		}
